...
if __name__ == "__main__":
    ...
    asin_list = get_deals_of_the_day(
        'https://www.amazon.com/events/collegedeals?ref=deals_deals_deals-grid_slot-15_39f3_dt_dcell_img_2_024739bb&deals-widget=%257B%2522version%2522%253A1%252C%2522viewIndex%2522%253A120%252C%2522presetId%2522%253A%252218E3A0C5517404FF40EBFF9C54BF4EA0%2522%252C%2522dealType%2522%253A%2522DEAL_OF_THE_DAY%2522%252C%2522sorting%2522%253A%2522BY_SCORE%2522%257D')
